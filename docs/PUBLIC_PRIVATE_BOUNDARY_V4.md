...
`ENGINE_MANIFEST.json` is component-local. `semantic_runtime_authority=false` means this public component does not own Control semantics; it does not mean the private V4 runtime is inactive.
