...
Dual-current prompt trust is not a supported steady-state or rollout mechanism. Git history carries predecessor identity; current runtime binding carries one accepted prompt hash.
