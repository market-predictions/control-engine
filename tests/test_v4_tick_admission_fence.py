...
RUN_ID = 'v4:6a9a7e0b18b08191876c134d83cfbba2:83ee437c017961ce:' + ('a' * 32)
OTHER_RUN_ID = 'v4:6a9a7e0b18b08191876c134d83cfbba2:83ee437c017961ce:' + ('b' * 32)
...
def test_stale_or_old_generation_command_is_rejected_before_private_write_capability() -> None:
    ...
    assert '6a9a7e0b18b08191876c134d83cfbba2:83ee437c017961ce' in admission
