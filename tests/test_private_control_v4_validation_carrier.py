...
def _canonical_prompt_fixture_text() -> str:
    return "\n".join(("status=ACTIVE_BOUND", *validator.STATELESS_TRANSPORT_PROMPT_REQUIRED_MARKERS, *validator.COMMAND_BINDING_PROMPT_REQUIRED_MARKERS, *validator.LIVE_TICK_RESPONSIBILITY_PROMPT_REQUIRED_MARKERS, *validator.LIVENESS_PROMPT_REQUIRED_MARKERS, *validator.TARGET_EFFECT_PROMPT_REQUIRED_MARKERS, *validator.CANONICAL_EVENT_PROMPT_REQUIRED_MARKERS, *validator.HOLDER_CLOSEOUT_PROMPT_REQUIRED_MARKERS, *validator.COMPLEXITY_BRAKE_PROMPT_REQUIRED_MARKERS, ""))
