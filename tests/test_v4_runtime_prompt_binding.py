...
def test_runtime_binding_accepts_only_current_stateless_prompt_contract() -> None:
    assert CANONICAL_RUNNER_PROMPT_BLOB_SHA == "09d50ff9f2c797b22f85f88314d562d7306abc53"
...
def test_runtime_binding_rejects_every_predecessor_prompt_after_stateless_cutover(prompt_blob_sha: str) -> None:
